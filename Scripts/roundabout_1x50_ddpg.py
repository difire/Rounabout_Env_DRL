...
from Algorithms.DDPG.ddpg3 import DDPG
...
if __name__ == '__main__':
    ...
    # 初始化智能体
    agent = DDPG(state_dim, action_dim, max_action, replay_buffer, device)

    # Train0()
    Test0(env, agent, 'roundabout_v1_1_1x50_DDPG3_174014446', 'best')